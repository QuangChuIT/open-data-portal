...
public interface CatalogLocalService
	...
	public Catalog addCatalog(
			...
			String version, boolean visibility, ServiceContext serviceContext)
	...
	public void addCatalogResources(
			Catalog catalog, ModelPermissions modelPermissions)
		throws PortalException;
	...
	public void addCatalogResources(
			long catalogId, ModelPermissions modelPermissions)
		throws PortalException;
