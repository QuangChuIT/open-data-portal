...
/**
 * The persistence utility for the dic data type service. This utility wraps <code>vn.vnpt.data.cms.service.persistence.impl.DicDataTypePersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class DicDataTypeUtil {
	 ...
	 */
	public static void clearCache(DicDataType dicDataType) {
		getPersistence().clearCache(dicDataType);
	}
	 ...
	 */
	public static Map<Serializable, DicDataType> fetchByPrimaryKeys(
	 ...
	 */
	public static List<DicDataType> findWithDynamicQuery(
	 ...
	 */
	public static DicDataType update(DicDataType dicDataType) {
		return getPersistence().update(dicDataType);
	}

	/**
	 * @see com.liferay.portal.kernel.service.persistence.BasePersistence#update(com.liferay.portal.kernel.model.BaseModel, ServiceContext)
	 */
	public static DicDataType update(
		DicDataType dicDataType, ServiceContext serviceContext) {

		return getPersistence().update(dicDataType, serviceContext);
	}
	 ...
	 */
	public static List<DicDataType> findByUuid(String uuid) {
	 ...
	 */
	public static List<DicDataType> findByUuid(
	 ...
	 */
	public static DicDataType findByUuid_First(
			String uuid, OrderByComparator<DicDataType> orderByComparator)
		throws vn.vnpt.data.cms.exception.NoSuchDicDataTypeException {
	 ...
	 */
	public static DicDataType fetchByUuid_First(
		String uuid, OrderByComparator<DicDataType> orderByComparator) {
	 ...
	 * @throws NoSuchDicDataTypeException if a matching dic data type could not be found
	 */
	public static DicDataType findByUuid_Last(
			String uuid, OrderByComparator<DicDataType> orderByComparator)
		throws vn.vnpt.data.cms.exception.NoSuchDicDataTypeException {
	 ...
	 */
	public static DicDataType fetchByUuid_Last(
		String uuid, OrderByComparator<DicDataType> orderByComparator) {
	 ...
	 */
	public static DicDataType[] findByUuid_PrevAndNext(
			long dicDataTypeId, String uuid,
			OrderByComparator<DicDataType> orderByComparator)
		throws vn.vnpt.data.cms.exception.NoSuchDicDataTypeException {

		return getPersistence().findByUuid_PrevAndNext(
			dicDataTypeId, uuid, orderByComparator);
	}
	 ...
	 * @throws NoSuchDicDataTypeException if a matching dic data type could not be found
	 */
	public static DicDataType findByUUID_G(String uuid, long groupId)
		throws vn.vnpt.data.cms.exception.NoSuchDicDataTypeException {
	 ...
	 */
	public static DicDataType fetchByUUID_G(String uuid, long groupId) {
	 ...
	 * @return the matching dic data type, or <code>null</code> if a matching dic data type could not be found
	 */
	public static DicDataType fetchByUUID_G(
	 ...
	 */
	public static DicDataType removeByUUID_G(String uuid, long groupId)
		throws vn.vnpt.data.cms.exception.NoSuchDicDataTypeException {
	 ...
	 * @return the matching dic data types
	 */
	public static List<DicDataType> findByUuid_C(String uuid, long companyId) {
	 ...
	 * @return the range of matching dic data types
	 */
	public static List<DicDataType> findByUuid_C(
	 ...
	 * @throws NoSuchDicDataTypeException if a matching dic data type could not be found
	 */
	public static DicDataType findByUuid_C_First(
	 ...
	 * @return the first matching dic data type, or <code>null</code> if a matching dic data type could not be found
	 */
	public static DicDataType fetchByUuid_C_First(
		String uuid, long companyId,
		OrderByComparator<DicDataType> orderByComparator) {
	 ...
	 * @throws NoSuchDicDataTypeException if a matching dic data type could not be found
	 */
	public static DicDataType findByUuid_C_Last(
			String uuid, long companyId,
			OrderByComparator<DicDataType> orderByComparator)
		throws vn.vnpt.data.cms.exception.NoSuchDicDataTypeException {
	 ...
	 * @return the last matching dic data type, or <code>null</code> if a matching dic data type could not be found
	 */
	public static DicDataType fetchByUuid_C_Last(
		String uuid, long companyId,
		OrderByComparator<DicDataType> orderByComparator) {
	 ...
	 * @throws NoSuchDicDataTypeException if a dic data type with the primary key could not be found
	 */
	public static DicDataType[] findByUuid_C_PrevAndNext(
			long dicDataTypeId, String uuid, long companyId,
			OrderByComparator<DicDataType> orderByComparator)
		throws vn.vnpt.data.cms.exception.NoSuchDicDataTypeException {

		return getPersistence().findByUuid_C_PrevAndNext(
			dicDataTypeId, uuid, companyId, orderByComparator);
	}
	 ...
	 * @return the matching dic data types
	 */
	public static List<DicDataType> findByGroupId(long groupId) {
	 ...
	 * @return the range of matching dic data types
	 */
	public static List<DicDataType> findByGroupId(
	 ...
	 * @throws NoSuchDicDataTypeException if a matching dic data type could not be found
	 */
	public static DicDataType findByGroupId_First(
	 ...
	 * @return the first matching dic data type, or <code>null</code> if a matching dic data type could not be found
	 */
	public static DicDataType fetchByGroupId_First(
		long groupId, OrderByComparator<DicDataType> orderByComparator) {
	 ...
	 * @throws NoSuchDicDataTypeException if a matching dic data type could not be found
	 */
	public static DicDataType findByGroupId_Last(
			long groupId, OrderByComparator<DicDataType> orderByComparator)
		throws vn.vnpt.data.cms.exception.NoSuchDicDataTypeException {
	 ...
	 * @return the last matching dic data type, or <code>null</code> if a matching dic data type could not be found
	 */
	public static DicDataType fetchByGroupId_Last(
		long groupId, OrderByComparator<DicDataType> orderByComparator) {
	 ...
	 * @throws NoSuchDicDataTypeException if a dic data type with the primary key could not be found
	 */
	public static DicDataType[] findByGroupId_PrevAndNext(
			long dicDataTypeId, long groupId,
			OrderByComparator<DicDataType> orderByComparator)
		throws vn.vnpt.data.cms.exception.NoSuchDicDataTypeException {

		return getPersistence().findByGroupId_PrevAndNext(
			dicDataTypeId, groupId, orderByComparator);
	}
	 ...
	 */
	public static void cacheResult(DicDataType dicDataType) {
		getPersistence().cacheResult(dicDataType);
	}
	 ...
	 */
	public static void cacheResult(List<DicDataType> dicDataTypes) {
		getPersistence().cacheResult(dicDataTypes);
	}
	 ...
	 */
	public static DicDataType create(long dicDataTypeId) {
		return getPersistence().create(dicDataTypeId);
	}
	 ...
	 * @throws NoSuchDicDataTypeException if a dic data type with the primary key could not be found
	 */
	public static DicDataType remove(long dicDataTypeId)
		throws vn.vnpt.data.cms.exception.NoSuchDicDataTypeException {

		return getPersistence().remove(dicDataTypeId);
	}

	public static DicDataType updateImpl(DicDataType dicDataType) {
		return getPersistence().updateImpl(dicDataType);
	}
	 ...
	 * @throws NoSuchDicDataTypeException if a dic data type with the primary key could not be found
	 */
	public static DicDataType findByPrimaryKey(long dicDataTypeId)
		throws vn.vnpt.data.cms.exception.NoSuchDicDataTypeException {

		return getPersistence().findByPrimaryKey(dicDataTypeId);
	}
	 ...
	 */
	public static DicDataType fetchByPrimaryKey(long dicDataTypeId) {
		return getPersistence().fetchByPrimaryKey(dicDataTypeId);
	}
	 ...
	 */
	public static List<DicDataType> findAll() {
	 ...
	 */
	public static List<DicDataType> findAll(int start, int end) {
	...
	public static DicDataTypePersistence getPersistence() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker
		<DicDataTypePersistence, DicDataTypePersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(DicDataTypePersistence.class);

		ServiceTracker<DicDataTypePersistence, DicDataTypePersistence>
			serviceTracker =
				new ServiceTracker
					<DicDataTypePersistence, DicDataTypePersistence>(
						bundle.getBundleContext(), DicDataTypePersistence.class,
						null);
